...
export default function FeedPage() {
  ...
  const handleLike = async (postId: string) => {
    ...
    try {
      ...
      setPosts(
        posts.map((p) =>
          p.id === postId
            ? { ...p, liked: alreadyLiked, likes_count: post.likes_count }
            : p
        )
      );
    }
  ...
  const handleSave = async (postId: string) => {
    ...
    // Optimistic update
    setPosts(
      posts.map((p) => (p.id === postId ? { ...p, saved: !alreadySaved } : p))
    );
        ...
        <div className="grid gap-6 lg:grid-cols-12">
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <p className="font-semibold text-gray-900">
                        {currentUser?.orders_completed || 0}
                      </p>
          ...
          <main className="lg:col-span-6">
            ...
            <div className="mb-4 rounded-lg bg-white p-4 shadow-sm">
                  ...
                  <div className="flex space-x-2">
                    {[
                      ...
                      <button
                        key={value}
                        onClick={() =>
                          setNewPost({ ...newPost, post_type: value as any })
                        }
              ...
              {/* Bottom icons when form is closed */}
              {!showPostForm && (
                ...
                {filteredPosts.map((post) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-around border-t p-2">
                      ...
                      >
                        <Heart
                          className={`h-5 w-5 ${post.liked ? 'fill-red-500 text-red-500' : 'text-gray-600'}`}
                        />
              ...
              <div className="rounded-lg bg-white p-4 shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-gray-900">
                      {
                        posts.filter((p) => p.post_type === 'job_request')
                          .length
                      }
                    </span>
                  </div>
